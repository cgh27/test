                    ...
                    <form action="/user/login"
                        ...
                        <div class="uinArea" id="uinArea">
                            ...
                            <div class="inputOuter" id="uArea">
                                <input type="text" id="u" name="name" value="<#if Session["user"]?exists>${Session["user"].UName}</#if>" class="inputstyle"/></div>
                        </div>
                        <div class="pwdArea" id="pwdArea">
                            <label class="input-tips" for="p">密码：</label>
                            <div class="inputOuter" id="pArea">

                                <input type="password" id="p" name="password" value="<#if Session["user"]?exists>${Session["user"].UPassword}</#if>" class="inputstyle"/>
                            </div>
                        </div>
    ...
    <div class="qlogin" id="qlogin" style="display: none;">
        <div class="web_login">
            <form name="form2" id="regUser" accept-charset="utf-8"
                  action="/user/register" method="post" autocomplete="off">
