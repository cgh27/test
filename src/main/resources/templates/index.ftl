...
<title>响应式布局</title>
<link type="text/css" rel="stylesheet" href="${base}/static/css/reset.css" />
<link type="text/css" rel="stylesheet" href="${base}/static/css/1024_768.css" />
<link type="text/css" rel="stylesheet" media="screen and (min-width:861px) and (max-width:960px)" href="${base}/static/css/pad_heng.css" />
<link type="text/css" rel="stylesheet" media="screen and (min-width:601px) and (max-width:860px)" href="${base}/static/css/pad.css" />
<link type="text/css" rel="stylesheet" media="screen and (min-width:481px) and (max-width:600px)" href="${base}/static/css/tel_heng.css" />
<link type="text/css" rel="stylesheet" media="screen and (max-width:480px)" href="${base}/static/css/tel.css" />
</head>
...
<div class="w_100_l">
	<div class="main">
      <div class="top_banner">
            <div class="top_logo"><img src="${base}/static/images/top_logo.jpg" alt="A BOOK APART LOGO" /></div>
            <div class="top_menu">
            	<ul>
                	<li class="sel"><a href="#">HOME</a></li>
                	<li><a href="booklist">STORE</a></li>
                	<li><a href="#">PRESS</a></li>
                	<li><a href="#">ABOUT</a></li>
                	<li><a href="#">HELP</a></li>
                </ul>
            </div>
            <div class="top_shop_cur"><a href="#"><img src="${base}/static/images/top_shop_cur.jpg" alt="shopping car" /></a></div>
        </div>
        <span class="index_img"><img src="${base}/static/images/banner_img.jpg" alt="Dan Cederholm" border="0" usemap="#Map" />
        <map name="Map" id="Map">
      ...
      <div class="content">
        	...
        	<ul>
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${base}/static/images/book_01.jpg" alt="book" /></a></dd>
                        <dt>
            	...
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${base}/static/images/book_02.jpg" alt="book" /></a></dd>
                        <dt>
            	...
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${base}/static/images/book_03.jpg" alt="book" /></a></dd>
                        <dt>
            	...
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${base}/static/images/book_04.jpg" alt="book" /></a></dd>
                        <dt>
            	...
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${base}/static/images/book_05.jpg" alt="book" /></a></dd>
                        <dt>
            	...
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${base}/static/images/book_06.jpg" alt="book" /></a></dd>
                        <dt>
            	...
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${base}/static/images/book_07.jpg" alt="book" /></a></dd>
                        <dt>
            	...
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${base}/static/images/book_08.jpg" alt="book" /></a></dd>
                        <dt>
            	...
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${base}/static/images/book_09.jpg" alt="book" /></a></dd>
                        <dt>
            	...
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${base}/static/images/book_10.jpg" alt="book" /></a></dd>
                        <dt>
            	...
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${base}/static/images/book_11.jpg" alt="book" /></a></dd>
                        <dt>
            	...
            	<li>
                	<dl>
                    	<dd><a href="#"><img src="${base}/static/images/book_12.jpg" alt="book" /></a></dd>
                        <dt>
                        	<p class="book_title"><a href="#" target="_blank">On Web Typography</a></p>
                            <p class="book_inline">by Jason Santa Maria</p>
                            <a class="book_buy" href="#" target="_blank">BUY</a>
        ...
        <div class="content_press">
        	<div class="press_porsen_01">
                <h1>Press Room</h1>
            	<dl>
                	<dd><img src="${base}/static/images/img_men.jpg" alt="person" /></dd>
                    <dt>
            ...
            <div class="press_porsen_02">
            	...
            	<dl>
                	<dd><img src="${base}/static/images/img_lives.jpg" alt="book img" /></dd>
                    <dt>
        ...
        <div class="footer">
           <span class="span_1">&copy; Copyright 2014, A Book Apart, LLC</span>&nbsp;&nbsp;
            ...
            <span class="span_2"><b>Published by</b><img src="${base}/static/images/icon_hg.jpg" align="absmiddle" /></span>
        </div>
    </div>
</div>
